...
**Answer**: The value of the 30th percentile is 34.5. This means 30 percent of cereals score less than 34.5.
...
**Answer**: The score tends to increase as the numver of reviews increase. 
...
**Answer**: The value of the 80th percentile is 30.00. This means 80 percent of teas cost less than $30.

Plot the number of reviews (x-axis) against the score variable. Color
the points according to price binned into 5 buckets.

```{r}
price <- group_summarize(tea, num_reviews) +
  ggplot(price, aes(num_reviews, score)) +
  geom_point(size = 3)
