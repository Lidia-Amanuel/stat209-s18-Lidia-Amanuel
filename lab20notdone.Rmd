...
**Answer**: As the carats increase the price of the diamond also increases with a factor of 7756.
...
```{r}
modeltwo <- lm_basic(price ~ 1 + carat, data = diamonds) 
...
**Answer**: It describes of the relatioship between the carats and price is positive or negative
